...
# Copy this to your project and import for environment-specific settings
...
DEVELOPMENT_CONFIG: Dict[str, Any] = {
    ...
    # Anomaly Detection Defaults (Overridden by LLM when manuals exist)
    ...
    # Database
    "database_url": "sqlite:///data/ecosync.db",
}

# ============================================================================
# PRODUCTION / LIVE DEMO ENVIRONMENT
# ============================================================================
PRODUCTION_CONFIG: Dict[str, Any] = {
    # Changed from /var/data/ to keep it self-contained for the demo VM
    "data_directory": "./data/", 
    "api_host": "0.0.0.0",
    "api_port": 8000,
    "log_level": "INFO",
...
CO2_FACTORS_BY_REGION: Dict[str, float] = {
    "North America": 0.425,
    "Europe": 0.350,
    "India": 0.625,  # Adjusted for high coal mix
    "China": 0.700,
    "Brazil": 0.150,  
    "Australia": 0.800,  
